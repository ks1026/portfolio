...
public class DBConnectionMgr {
    ...
    */
    ...
    public DBConnectionMgr() throws Exception {
		...
		String location="C:/webtest/4.jsp/sou/OneStepTrip2/src/main/webapp/dbtest/oracle.properties";
		String location2="C:/webtest/4.jsp/sou/OneStepTrip2/src/main/webapp/dbtest/"+decryptFileName;//암호파일
		
		//1)DB파일설정파일->암호화시켜서 암호화파일 생성
		Crypt.encryptFile(location, location2);//원본파일명,생성할암호화파일명
    	
    	//  복호화 시키기위한 암호화된 파일 불러오기
    	String location3 = "C:/webtest/4.jsp/sou/OneStepTrip2/src/main/webapp/dbtest/orclEnc.properties"; // 암호화 파일
    	String location4 = "C:/webtest/4.jsp/sou/OneStepTrip2/src/main/webapp/dbtest/backup/orcl.properties"; // 암호화된 파일을 복호화한 후 
    	
    	System.out.println("location3 : " + location3);
    	System.out.println("location4 : " + location4);
		Crypt.decryptFile(location3, location4); 
		
		// 복호화된 파일 (orcl.properties)-> Properties객체를 생성 -> 메모리에 올려서 각키불러오기
		Properties props=new Properties();
		
    	FileInputStream in = new FileInputStream(location4);
//    	Properties props = new Properties();
//    	FileInputStream in = new FileInputStream("C:\\webtest\\4.jsp\\sou\\OneStepTrip\\src\\main\\webapp\\dbtest\\oracle.properties");
