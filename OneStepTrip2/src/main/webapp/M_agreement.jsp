...
<head>
<meta charset="UTF-8">
<title>회원동의약관(agreement.jsp)</title>
</head>
<style>
	.im{
		width:100%;
...
<p></p>
<input type="button" value="동의합니다" onclick="location.href='M_register.jsp'" class="btn btn-success">
<input type="button" value="동의하지 않습니다." onclick="history.go(-1)" class="btn btn-warning">
</center>
<!-- footer -->
